 ...
 */
package com.android.server.witaqua.display;
...
import com.android.server.witaqua.display.TwilightTracker.TwilightState;

import java.io.PrintWriter;
import java.util.BitSet;

import com.android.internal.witaqua.hardware.LineageHardwareManager;
import com.android.internal.witaqua.hardware.LiveDisplayManager;
import com.android.internal.util.witaqua.ColorUtils;

import static com.android.internal.witaqua.hardware.LiveDisplayManager.MODE_AUTO;
import static com.android.internal.witaqua.hardware.LiveDisplayManager.MODE_DAY;
import static com.android.internal.witaqua.hardware.LiveDisplayManager.MODE_NIGHT;
import static com.android.internal.witaqua.hardware.LiveDisplayManager.MODE_OFF;
...
public class ColorTemperatureController extends LiveDisplayFeature {
    ...
    public ColorTemperatureController(Context context,
        ...
        mColorBalanceCurve = com.android.internal.util.witaqua.MathUtils.powerCurve(
    ...
    private int mapColorTemperatureToBalance(int temperature) {
        double z = com.android.internal.util.witaqua.MathUtils.powerCurveToLinear(mColorBalanceCurve, temperature);
